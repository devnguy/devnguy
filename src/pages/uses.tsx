...
export default () => (
  <Main title="devin nguyen uses">
    <ul>
      <li>Work: MacBook Pro (16-inch, 2019)</li>
      <li>Play: Nvidia RTX 3070, AMD Ryzen 5600x, NZXT H510i</li>
      <li>Monitors: LG 27GL83A-B (27” 1440p) + Asus VG248QE (24” 1080p) </li>
      <li>
        Keyboard: Custom 65% with Holy Panda switches, GMK Laser keycaps, Tofu
        case
      </li>
      ...
      <li>Landing page: A possibly overused gimmick :)</li>
    </ul>
  </Main>
)
